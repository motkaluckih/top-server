...
{block 'contentInner'}
                ...
                <div class="col-12 col-lg-5">
                    <div class="description__content">
                        <p class="description__text">
                            Бесплатно доставим сжиженный углеводородный газ (пропан-бутан) в {$_modx->resource.pagetitle}.
    ...
    {include 'file:templates/base/includes/featuresImages.tpl'
        ...
        tvParam = 10 | resource : 'delivery.SEO.Why'
    }
