    ...
    <form role="form" method="post" class="w-100" action="{$_modx->resource.id | url}" onSubmit="yaCounter{$_modx->config.yandex}.reachGoal('{$reachGoal}');">
        <div class="form-row">
            ...
            <div class="col-12 text-center">
                <button type="submit" class="btn-theme btn-theme__color_red btn-theme__size_4" style="width: 100% !important;">
                    <span>Забронировать</span>
                </button>
            </div>
            <div class="col-12 text-center mt-2">
                <button onclick="$.fancybox.close()" class="btn-no btn-no__color_gray btn-no__size_4" style="width: 100% !important; text-align: center;">
                    <span>Отказаться от выгоды</span>
                </button>
            </div>
        </div>
    </form>
