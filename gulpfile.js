...
export const dev = gulp.series(
  clean,
  gulp.parallel([pug, stylesDev, imagesDev, fonts, misc, scriptsDev, svg]),
  gulp.parallel(server, watcher)
);

export const prod = gulp.series(
  clean,
  gulp.parallel([pug, stylesProd, imagesProd, fonts, misc, scriptsProd, svg])
);

export default dev;
export const htmlDeploy = gulp.series(pug);
